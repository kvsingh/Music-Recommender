...
<html>
	<head>
		...
		<style>
			...
			ul li{list-style:none; padding-bottom:.5em; overflow:auto; margin:1em 0; background:#ddd; -moz-border-radius:10px; padding:10px; position:relative;}
			p {padding-left:80px;}
	...
	<body class="yui-skin-sam">
		<div id="doc" class="yui-t7">
			...
			<div id="bd" role="main">
				<?php	$firehose = 'select * from social.updates.search(50) where query="ipad"';
						$data = $yahoo_session->query($firehose);
						echo '<ul>';
						foreach($data->query->results->update as $u)
						{
							echo '<li><p><a href="' . $u->profile_uri . '"><img src="' . $u->profile_displayImage . '" alt="' . $u->profile_nickname . '"></a><a href="' . $u->link . '">' . $u->title . '</a></p><p>' . $u->description . '</p><p class="via">via ' . $u->loc_localizedName . '</p></li>';
						}
						echo '</ul>';
